...
namespace RPG.CameraUI
{
    public class CameraRaycaster : MonoBehaviour
	{
		...
		// OnMouseOverCollectables
		public delegate void OnMouseOverCollectables (Interactable item);
		public event OnMouseOverCollectables onMouseOverCollectables;
		...
		private bool RaycastForInteractable (Ray ray)
        {
			...
			// Store the EnemyAI.cs component in enemyHit variable, identify it by component
			var itemHit = gameObjectHit.GetComponent<Interactable>();

			// If there is an itemHit, if theres is a component Interactable Do this.
			if (itemHit)
			{
				// Change cursor
				...
				// Broadcast, onMouseOverEnemy with the EnemyAI reference.
				onMouseOverCollectables(itemHit);
