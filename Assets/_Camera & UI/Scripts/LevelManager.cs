...
public class LevelManager : MonoBehaviour
{
	...
	[SerializeField] GameObject whiteCross;


	AsyncOperation asyncloadSceneInTheBackground;

	[SerializeField] GameObject particlePrefab = null;
	[SerializeField] GameObject whiteCross_Fx;
    ...
    public void OnClickButton()
	{
		...
		// var whiteCrossAnimator = whiteCross.GetComponent<Animator>();
		// whiteCrossAnimator.SetTrigger ("TriggerCross");
	...
	{
		//var particlePrefab = gameObject.GetComponent<GameObject>();

		var particleObject = Instantiate(particlePrefab, parent);
		
		//particleObject.GetComponent<ParticleSystem>().Play();

		var whiteCrossParticles = Instantiate(whiteCross_Fx, parent);
		
		//whiteCrossParticles.GetComponent<ParticleSystem>().Play();
	}
}
